...
class AuthService {
    static register(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hashedPassword = yield bcrypt.hash(password_hash, salt);
            const matchRole = role;
            const newUser = userRepository.create(Object.assign(Object.assign({}, data), { password_hash: hashedPassword, role: matchRole }));
    ...
    static login(username, password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token = jwt.sign({ userId: user.id, username: user.username, role: user.role }, process.env.JWT_SECRET || "mobi_tech_secret", { expiresIn: "1h" });
            return { user, token };
        });
    }
}
